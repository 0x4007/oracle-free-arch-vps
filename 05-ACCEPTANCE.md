...
- [ ] One approved OCI `SOFTSTOP` test reached `STOPPED` within 1,200 seconds,
      or the setup is explicitly marked as awaiting that controlled test.
- [ ] The previous boot journal shows an orderly shutdown after the controlled
      `SOFTSTOP` test.
